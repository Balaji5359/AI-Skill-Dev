...
function Role_BasedInterviewData() {
    ...
    const CircularProgress = ({ percentage, size = 120, strokeWidth = 10, color = '#1d9b21ff' }) => {
    ...
    return (
        <div className="jam-dashboard">
            <div className="dashboard-header">
                <h1>Here is your Role Based Interview Test with GenAI Agent Details</h1>
                ...
                {activeTab === 'start' && (
                    <div className="start-tab">
                        ...
                        <div className="test-activities">
                            <button 
                                onClick={() => window.location.href = '/role-based-interview-instructions'}
                                className="test-activity-btn"
                            >
                                Role Based Interview - Click here to take Interview
                            </button>
                        </div>
                    </div>
                )}
...
export default Role_BasedInterviewData;